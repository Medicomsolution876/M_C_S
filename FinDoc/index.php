	...
	<main>
			...
			<div class="content">
				...
				<form method="post" action="">
					<div id="custom-search-input">
						...
						<!--	<li>
								<input type="radio" id="Prescription" name="radio_search" value="Get Your Prescription">
		...
		<div class="container margin_120_95">
			<div class="main_title">
				...
				<p>Get an appointment at the nearest doctor just with a few clicks.</p>
			</div>
			<div class="row add_bottom_30">
				<div class="col-lg-4">
					<div class="box_feat" id="icon_1">
						<span></span>
						<h3>Find a Doctor</h3>
						<p>We allow you to find the nearest doctor with the support of Google maps on our web app.</p>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="box_feat" id="icon_2">
						<span></span>
						<h3>View profile</h3>
						<p>Allows you to view the profile of the doctor you are visiting.</p>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="box_feat" id="icon_3">
						<h3>Book a visit</h3>
						<p>Book your appointment with the doctors according to your disease.</p>
					</div>
				</div>
			</div>
			<!-- /row -->
